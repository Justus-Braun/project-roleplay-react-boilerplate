# Project Roleplay React Boilerplate

This Boilerplate is based on the Boilerplate from [ProjectError](https://github.com/project-error/fivem-react-boilerplate-lua)
